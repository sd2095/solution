...
@Model(adaptables = SlingHttpServletRequest.class, adapters = {
		MoleculeComponentModel.class }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = MoleculeComponentModel.RESOURCE_TYPE)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class MoleculeComponentModel implements ComponentExporter {

	public static final String RESOURCE_TYPE = "solution/components/molecule-component";
